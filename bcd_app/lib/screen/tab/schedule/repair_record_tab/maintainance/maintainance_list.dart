...
import 'package:bcd_app/screen/tab/schedule/component/maintainance_box.dart';
...
class MaintainanceList extends StatefulWidget {
  DateTime selectedDate;
  final UserDTO dto;
  MaintainanceList(this.selectedDate, this.dto);
  @override
  State<StatefulWidget> createState() {
    return _maintainanceListState();
  }
}

// ignore: camel_case_types
class _maintainanceListState extends State<MaintainanceList> {
  ...
  Widget build(BuildContext context) {
    _getBloc.add(GetListWaitingMaintainance());
    return BlocProvider(
                  ...
                  child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        return state.listDTO[index].maintenanceDate
                                ...
                                state.listDTO[index].status ==
                                    MaintenanceOrderStatus.WaitingForMaintenance
                            ? MaintainanceBox(widget.dto, state.listDTO[index])
                            : Container();
                      }),
                ),
                SizedBox(height: 100)

...
class FixedDetail extends StatefulWidget {
...
class _DetailsState extends State<FixedDetail> {
  ...
  Widget build(BuildContext context) {
    _getBloc = new GetMaintainanceByIdBloc(widget.maintenanceOrderId);

...
import 'crack_verify_box.dart';

class CrackVerifyList extends StatefulWidget {
  final UserDTO dto;
  CrackVerifyList(this.dto);
  @override
  State<StatefulWidget> createState() {
    return _CrackVerifyListState();
  }
}

class _CrackVerifyListState extends State<CrackVerifyList> {
